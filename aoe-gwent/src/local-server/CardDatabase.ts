...
export class CardDatabase {
	...
	private static readonly cards: CardData[] = [
...

		{
			...
			score: 0,
			type: CardType.MELEE,
			effect: CardEffect.BOOST,
			onPlayEffect: TriggerEffects.forgingEffect,
		},
		{
			id: 202,
			name: "Iron Casting",
			...
			type: CardType.MELEE,
			effect: CardEffect.BOOST,
			onPlayEffect: TriggerEffects.ironCastingEffect,
		},
		{
			id: 203,
			name: "Blast Furnace",
			...
			type: CardType.MELEE,
			effect: CardEffect.BOOST,
			onPlayEffect: TriggerEffects.blastFurnaceEffect,
		},
		{
			id: 204,
			name: "Fletching",
			...
			type: CardType.RANGED,
			effect: CardEffect.BOOST,
			onPlayEffect: TriggerEffects.fletchingEffect,
		},
		{
			id: 205,
			name: "Bodkin Arrow",
			...
			type: CardType.RANGED,
			effect: CardEffect.BOOST,
			onPlayEffect: TriggerEffects.bodkinArrowEffect,
		},
		{
			id: 206,
			name: "Bracer",
			...
			type: CardType.RANGED,
			effect: CardEffect.BOOST,
			onPlayEffect: TriggerEffects.bracerEffect,
		},
	] as const;
}
